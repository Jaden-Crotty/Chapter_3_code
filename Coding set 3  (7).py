...
# removed if statement was pointless 
...
# ### we have a group of freinds and need to make a code  to find if they are vegetartion, vegan , or gluten free 

# In[23]:


# added input to ask user for input 
vegetarian = input('Is anyone in your party a vegetarian? ')
vegan = input('Is anyone in your party a vegan? ') 
gluten_free = input('Is anyone in your party gluten_free? ') 
# entered if statemnts if no the print function wont show
# if yes the print function will show 
